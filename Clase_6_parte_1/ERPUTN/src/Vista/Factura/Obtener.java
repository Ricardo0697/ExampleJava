...
public class Obtener extends ObtenerMain {
    ...
    public void CargarDatos() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][]{},
                new String[]{
                    "Id", "Fecha", "Cliente", "Exento","Gravado","Subtotal","Total"
                }
        ));
        ...
        List<Factura> facturas = facturaLogica.Obtener();
        for (int i = 0; i < facturas.size(); i++) {
            Object[] fila = new Object[7];
            fila[0] = ((Factura) facturas.get(i)).getId();
            fila[1] = ((Factura) facturas.get(i)).getFecha();
            fila[2] = ((Factura) facturas.get(i)).getCliente().getNombre();
            fila[3] = ((Factura) facturas.get(i)).getExento();
            fila[4] = ((Factura) facturas.get(i)).getGravado();
            fila[5] = ((Factura) facturas.get(i)).getSubtotal();
            fila[6] = ((Factura) facturas.get(i)).getTotal();
            modelo.addRow(fila);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista.Factura.Obtener().setVisible(true);
            }
        });
    }
