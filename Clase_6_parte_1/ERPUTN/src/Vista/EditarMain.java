 ...
 * @author Ricardo
 */
public class EditarMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(628, 85));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarMain().setVisible(true);
            }
        });
    }
    ...
    public void setLblTitle(String lblTitle) {
        this.lblTitle.setText("Editar "+lblTitle);
    }
}
